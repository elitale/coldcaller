...
/**
 * SIP registration credentials for a Telnyx (or compatible) SIP trunk.
 *
 * <p>Stored via OS keychain — never in SQLite in plaintext.
 *
 * @param username   SIP username (e.g. a Telnyx phone number in E.164)
 * @param password   SIP password; kept as a String because JAIN-SIP requires it
 * @param domain     SIP domain / realm (e.g. {@code sip.telnyx.com})
