...
/**
 * Pure formatting helpers for the dialer's "Recent Calls" rows: a humanized "time ago" label and a
 * pluralized call-count label.
 */
public final class RecentCallFormatter {
   ...
   *
   * <p>Examples: {@code "Just now"}, {@code "5 min ago"}, {@code "2 hours ago"}, {@code
   * "Yesterday"}, {@code "3 days ago"}, {@code "Jun 12"}.
   *
