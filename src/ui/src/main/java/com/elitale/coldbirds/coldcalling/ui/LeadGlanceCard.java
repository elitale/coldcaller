 ...
 *
 * <p>Shows the 3-second glance always (name, company·title, DNC, status, tags) and hides every
 * other field — email, all custom columns, notes, added date — behind a single <em>"Show all fields
 * ▸"</em> expander. This satisfies "all the data with all the columns" without dumping a
 * spreadsheet on screen mid-call.
 *
 * <p>Field tiering is decided by the headless {@link LeadFieldDigest}; this class only renders it.
 * Build on the FX thread.
 */
